...
export default function App({ Component, pageProps }: AppProps) {
  return (
    <>
      <Head>
        <title>Rishabh Tripathi | Bioinformatics & ML</title>
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Rishabh Tripathi | Bioinformatics & ML" />
        ...
        <meta name="twitter:title" content="Rishabh Tripathi | Bioinformatics & ML" />
      </Head>
      <Component {...pageProps} />
    </>
  )
